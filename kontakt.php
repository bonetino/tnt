		...
		<div id="fh5co-contact" class="animate-box">
			<div class="container">
				<form action="#">
					<div class="row">
						<div class="col-md-6">
							<p>Možete nas kontaktirati na jedan od dolje navedenih načina.</p>
							<ul class="contact-info">
								<li><i class="icon-microphone"></i>Gaj 18, 72270 Travnik, BiH</li>
								<li><i class="icon-bubbles"></i>Oglašavanje:
								Alem Lolić
								+387 62 889 889
								tnt@tnt.ba</li>
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<textarea name="" class="form-control" id="" cols="30" rows="7" placeholder="Vaša poruka"></textarea>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<input type="submit" value="Pošalji poruku" class="btn btn-primary">
									</div>
								</div>
							</div>
						</div>
