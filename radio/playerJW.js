...
var jwBase64 = {
  ...
  decode: function(e) {
    ...
    while (f < e.length) {
      s = jwBase64._keyStr.indexOf(e.charAt(f++));
      o = jwBase64._keyStr.indexOf(e.charAt(f++));
      u = jwBase64._keyStr.indexOf(e.charAt(f++));
      a = jwBase64._keyStr.indexOf(e.charAt(f++));
      n = s << 2 | o >> 4;
      r = (o & 15) << 4 | u >> 2;
      i = (u & 3) << 6 | a;
...
jwplayer.key = '+x6Te1krzlyHySZd27dvZkKOGKQAXV0BnO8SAg==';
if (location.protocol === 'https:') {
  jwplayer.defaults = {
    flashplayer: 'https://ssl.p.jwpcdn.com/6/12/jwplayer.flash.swf',
    html5player: 'https://ssl.p.jwpcdn.com/6/12/jwplayer.html5.js',
    ph: 1
  }
} else {
  jwplayer.defaults = {
    flashplayer: 'http://p.jwpcdn.com/6/12/jwplayer.flash.swf',
    html5player: 'http://p.jwpcdn.com/6/12/jwplayer.html5.js',
    ph: 1
  }
};