...
function CheckAuthentication()
{
	...
	return isset($_SESSION['FileBrowserIsAuthorized']) && $_SESSION['FileBrowserIsAuthorized'];
...
*/
$temp = explode ("admin", "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
$baseUrl = $temp[0].'images/files/';
...
$config['plugin_imageresize']['smallThumb'] = '120x120';
$config['plugin_imageresize']['mediumThumb'] = '160x160';
